                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                      ...
                      <li> <a href="#learn">Mi perfil</a> </li>
                ...
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      ...
                      <a href="#">Inicio</a> <a href="#">Registrate</a>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      ...
                      <a href="#">Inicio</a><a href="#">Registrar</a>
                    </div>
                  </div>
    ...
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          ...
          <a href="Javascript:void(0)">Inicia Session</a>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
...
<div id="important" class="important">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          <h2>Somos <strong class="yellow">Los mejores cursos</strong></h2>
          <span>que esperas para ser parte de nosotros, registrate, es totalmente gratis</span>
        </div>
      </div>
    </div>
  </div>
...
<div id="learn" class="learn">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          <h2>escribenos <strong class="yellow">te gustara   estar con nosotros</strong></h2>
...
<div class="make">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="titlepage">
          <h2>HAS QUE <strong class="white_colo">TUS CURSOS DESTAQUEN</strong></h2>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_text">
          ...
          <a href="Javascript:void(0)">Registrate</a>
        </div>
      </div>
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_img">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          ...
          <form class="contact_bg">
            <div class="row">
              <div class="col-md-12">
                <div class="titlepage">
                  <h2>Contactanos <strong class="yellow"></strong></h2>
                </div>
                <div class="col-md-12">
                  <input class="contactus" placeholder="Nombre" type="text" name="Your Name">
                </div>
                <div class="col-md-12">
                  <input class="contactus" placeholder="Correo Electronico" type="text" name="Your Email">
                </div>
                <div class="col-md-12">
                  <input class="contactus" placeholder="Telefono-Celular" type="text" name="Your Phone">
                </div>
                <div class="col-md-12">
                  <textarea class="textarea" placeholder="Messages" type="text" name="Message"></textarea>
                </div>
      ...
      <div class="footer ">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12">
              <form class="news">
                <input class="newslatter" placeholder="Correo Electronico" type="text" name=" Email">
                <button class="submit">Subscribete</button>
              </form>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
              ...
              <div class="copyright">
                <div class="container">
                  <p>Copyright © 2022 <a href="#">Todos los derechos reservados</a></p>
                </div>
              </div>
            </div>
          </footr>
